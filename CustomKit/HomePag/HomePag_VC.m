...
- (void)GetData{
    ...
    self.SectionArray = [NSMutableArray arrayWithArray:@[@"UIKit",@"CALayer",@"Audio and Video",@"Animation",@"FileDownload",@"GCD"]];
    
    self.ClassNameArray = [NSMutableArray arrayWithArray:@[@"UiKit_VC",@"CALayer_VC",@"",@"",@"FileDownload_VC",@"GCD_VC",@"",@"",@"",@""]];
