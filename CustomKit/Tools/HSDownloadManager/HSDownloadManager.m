...
// 缓存主目录
#define HSCachesDirectory [NSString stringWithFormat:@"%@",[[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"UniAppWgt"]]

// 保存文件名
#define HSFileName(url)  [NSString stringWithFormat:@"__UNI__300F90A.wgt"] //url.md5String //[NSString stringWithFormat:@"%@.zip",url.md5String]
...
- (void)createCacheDirectory
{
    ...
    //@"KeJianCache_%@",[User sharedInstance].DownloadID
...
//    }
   ...
   NSURLSession *session = [NSURLSession sessionWithConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration] delegate:self delegateQueue:[[NSOperationQueue alloc] init]];
    ...
    request=[NSMutableURLRequest requestWithURL:[NSURL URLWithString:url] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:30];
